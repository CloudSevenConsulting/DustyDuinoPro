/*
 * AccelMagno.h is part of the duinoPRO firmware. 
 *
 ...
 *
 */
class AccelMagno : public Module {
    private:
    ...
    public:
		/** @brief Constructor for AccelMagno
		 *  @param id - the location of the AccelMagno module on the duinoPRO baseboard.
		 */
		AccelMagno(int id);
